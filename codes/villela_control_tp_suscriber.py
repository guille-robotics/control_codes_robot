...
# Este codigo se suscribe al topico que contiene el TP.
...
class VillelaControl(Node):
    ...
    def target_callback(self, msg):
        self.goal_x = msg.x
        self.goal_y = msg.y
        self.get_logger().info(f"Nuevo punto objetivo: ({self.goal_x}, {self.goal_y})")
